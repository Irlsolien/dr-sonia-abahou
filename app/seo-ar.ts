...
export const metaAr = {
  title: "طبيبة الغدد الصماء والسكري بتمارة | الدكتورة سونيا أبحو",
  description:
...
export const uiAr = {
  ...
  hero: {
    eyebrow: "الغدد الصماء · السكري · الأمراض الاستقلابية",
  ...
  cabinet: {
    ...
    localNote:
      "عيادة أمراض الغدد الصماء والسكري بحي المسيرة 1، تمارة، مفتوحة لمرضى تمارة والمناطق المجاورة.",
    rabatLinkLabel: "معلومات لمرضى الرباط",
