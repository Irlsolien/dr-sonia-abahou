    ...
    >
      ...
      <section className="legal-content section-shell">
        ...
        <article>
          ...
          <p>
            إذا وضعت العيادة لاحقًا استمارة طبية أو فضاءً للمريض أو تطبيقًا
            للتتبّع، فسيتعيّن تحديد إطار خاص قبل النشر: إعلام واضح، وأمن مُعزَّز،
            ومدة احتفاظ ملائمة، وإجراءات CNDP عند الاقتضاء.
          </p>
        </article>
        ...
        <article>
          ...
          <p>
            يتم حجز الاستشارة بالفيديو عبر Calendly. وتقتصر المعطيات المعالَجة في
            هذه المرحلة على الاسم والبريد الإلكتروني والموعد المختار؛ ولا تُطلب أي
            معلومة طبية. يُسجَّل الموعد في أجندة العيادة (Outlook) ويُوفَّر رابط
            الفيديو عبر Zoom. وقد يعالج هؤلاء المزوّدون المعطيات خارج المغرب، في
            الحدود اللازمة للحجز وإجراء الاستشارة.
          </p>
          <p>
            يجري التبادل الطبي عبر مكالمة الفيديو ولا يُسجَّل على الموقع. أما
            الإجراءات المتعلقة بالطب عن بُعد ونقل المعطيات فتعود إلى المسؤول عن
            المعالجة.
          </p>
        </article>
        ...
        <article>
          ...
          <p>
            ...
            الموقع، مثل خرائط Google وواتساب وLinkedIn وInstagram وCalendly
            وZoom. ولا يُستدعى أيٌّ من هذه الخدمات تلقائيًا: فهي لا تُفتَح إلا
            بفعلٍ من المستخدم. وخريطة
