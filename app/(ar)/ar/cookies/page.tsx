  ...
  return (
    ...
    >
      ...
      <section className="legal-content section-shell">
        ...
        <article>
          <h2>الحجز عبر الإنترنت (Calendly)</h2>
          <p>
            تقترح صفحة الاستشارة بالفيديو حجز موعد عبر Calendly. لا يُحمَّل
            الجدول إلا بعد نقرة على «اختيار موعد»: ولا يُودَع أي سكربت أو ملف
            تعريف ارتباط خاص بـ Calendly ما لم يقم المستخدم بهذه النقرة. وبمجرد
            فتحه، قد يودِع Calendly ملفات تعريف الارتباط اللازمة لاشتغاله ويطبّق
            قواعده الخاصة بالخصوصية. ولا ينبغي إدخال أي معلومة طبية في استمارة
            الحجز.
          </p>
        </article>
