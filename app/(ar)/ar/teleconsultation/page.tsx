...
export const metadata: Metadata = {
  ...
  description:
    "احجزوا استشارة بالفيديو مع الدكتورة سونيا أبحو، طبيبة الغدد الصماء بتمارة: اختيار الموعد عبر الإنترنت، الأداء بالتحويل البنكي ورابط فيديو آمن.",
  alternates: {
  ...
  openGraph: {
    title: "الاستشارة بالفيديو | الدكتورة سونيا أبحو",
    description:
      "استشيروا الدكتورة سونيا أبحو عن بُعد: موعد عبر الإنترنت، أداء بالتحويل البنكي، رابط فيديو آمن.",
...
const steps = [
  ...
  },
  {
    ...
    text: "بعد التحقّق من الأداء، تستلمون التأكيد ورابط الفيديو الخاص بالاستشارة.",
  },
] as const;
...
const teleconsultationFaq = [
  {
    ...
    answer:
      "تجري الاستشارة عبر مكالمة فيديو آمنة. يُرسَل إليكم الرابط الآمن عبر البريد الإلكتروني بعد التحقّق من الأداء، ويكفي فتحه في موعد الاستشارة.",
  },
  {
    ...
    >
      ...
      >
        ...
        <p>
          ...
          موعدًا، وأدّوا عبر التحويل البنكي، ثم استلموا رابط الفيديو الآمن.
