      ...
      <section className="legal-content section-shell">
        ...
        <article>
          ...
          <ul>
            ...
            <li>إحصاءات الإقبال (Google Analytics)، فقط بعد قبول ملفات تعريف الارتباط.</li>
          </ul>
        </article>
        ...
        <article>
          ...
          <ul>
            ...
            <li>قياس إقبال الزوار على الموقع لتحسين معلوماته العملية، بموافقتكم؛</li>
        ...
        <article>
          ...
          <p>
            بموافقتكم المُعبَّر عنها عبر شريط ملفات تعريف الارتباط، يستعمل الموقع
            Google Analytics 4 (Google Ireland Limited) لقياس إقباله: الصفحات
            المُتصفَّحة، ومصدر الزيارات، ونوع الجهاز، والبلد. تودع هذه الأداة
            ملفات تعريف ارتباط وتُعالِج معطيات تقنية (مُعرِّف عشوائي، عنوان IP
            مُقتطَع وغير محفوظ) قد تُعالَج خارج المغرب، لا سيّما في الولايات
            المتحدة الأمريكية. ولا يُودَع أي ملف تعريف ارتباط من Google دون
            موافقتكم، ويمكن سحب اختياركم في أي وقت عبر «إدارة ملفات تعريف
            الارتباط». وترد التفاصيل في{" "}
            <Link href="/ar/cookies">سياسة ملفات تعريف الارتباط</Link>.
          </p>
          <p>
          ...
          <p>
            وبما أنّ الموقع يُوزَّع عبر شبكة Cloudflare، فقد يكون قياس جمهور مجهول
            (Cloudflare Web Analytics) نشِطًا أيضًا: دون ملف تعريف ارتباط، ودون
            تعقّب فردي، ومقتصرًا على إحصاءات مُجمَّعة للتصفّح والأداء. وقد تُعالَج
            هذه المعطيات التقنية خارج المغرب.
          </p>
          <p>
